...
/* =========================
   Camera helpers (Pixel-based)
   ========================= */

// centerCameraOnPlayer centers the camera (in pixels) on the player's pixel position.
...
// If the player leaves the dead zone, we shift the camera by the overlap.
